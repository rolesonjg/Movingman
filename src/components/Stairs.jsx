...
const Stairs = () => {
  ...
  return (
    <div>
      <div style={{fontFamily:" Poppins, sans-serif",fontWeight:"600",fontSize:"50px",color:"#074173",paddingLeft:"100px",paddingBottom:"100px"}} className="points">Points: {points}</div>
